...
function init() {
    ...
    addColumnAgentGroup(agentData, 3, RADIUS * 4, {x: 30, z: 25}, {x: -25, z: 25}, 0.6, "X");
    addColumnAgentGroup(agentData, 4, RADIUS * 4, {x: 25, z: 20}, {x: -25, z: 20}, 0.7, "X");
    addColumnAgentGroup(agentData, 4, RADIUS * 4, {x: 25, z: 10}, {x: -25, z: 10}, 0.8, "X");
    addColumnAgentGroup(agentData, 4, RADIUS * 4, {x: 25, z: 6 }, {x: -25, z: 6}, 0.8,  "X");
